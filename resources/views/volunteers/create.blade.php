...
<div class="max-w-xl mx-auto py-8 px-4">
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">New Volunteer</h1>
    <form method="POST" action="{{ route('volunteers.store') }}" class="bg-white shadow-lg rounded-xl p-6 space-y-6">
        @csrf
        <div>
        ...
        <div>
            ...
            <textarea class="border rounded-lg p-2 w-full focus:ring focus:ring-blue-200" name="notes" placeholder="Notes"></textarea>
        </div>
